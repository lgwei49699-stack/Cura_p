...
class MachineManager(QObject):
    ...
    activeMachineIdChanged = pyqtSignal(str)
    ...
    def setActiveMachine(self, stack_id: Optional[str]) -> None:
        ...
        _active_machine_id = global_stack.definition.getId()
        self.activeMachineIdChanged.emit(_active_machine_id)
        Logger.debug("machine id------%s", _active_machine_id)
    ...
    @pyqtProperty(str, notify=activeMachineIdChanged)
    def getActiveMachineId(self) -> str:
    ...
    def activeQualityLayerHeight(self) -> float:
        ...
        Logger.debug("layer height%f---:", value)
        return value
    ...
    def activeQualityDisplayNameMap(self) -> ActiveQuality:
        ...
        Logger.debug("****%s, %s, %f", self.activeQualityOrQualityChangesName, global_stack.quality.getName(), self.activeQualityLayerHeight)
