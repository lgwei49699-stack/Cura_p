...
{
    id: base
    width: actionPanelWidget.width + additionalComponents.width + 40
    height: childrenRect.height
    visible: CuraApplication.platformActivity

    property bool hasPreviewButton: true
    property bool hasPrintButton: false
    ...
    Rectangle
    {
        ...
        width: UM.Theme.getSize("action_panel_widget").width + 40
        ...
        Loader
        {
            ...
            onLoaded:
            {
                if(actionPanelWidget.outputAvailable)
                {
                    ...
                    //loader.item.machineId = base.machineId;
                    console.log("Signal received with ID-2:", base.machineId);

                    loader.item.hasPrintButton = (((base.machineId === "") ? PythonHandler.active_machine_id : base.machineId)  === "explorer_3");
                }
                else 
                {
                    loader.item.hasPrintButton = (PythonHandler.active_machine_id === "explorer_3");
                    console.log("Signal received with ID-init:", base.machineId);
                }
            }
        }
