...
Column
{
    ...
    property alias hasPrintButton: printButton.visible
    ...
    Item
    {
        ...
        width: parent.width 
        signal openMachineSelectionDlgRequested()
        Cura.SecondaryButton
        {
            id: previewStageShortcut
            fixedWidthMode: true
            anchors.left: parent.left
            width: printButton.visible ? (parent.width / 3 - 20) : (parent.width / 2 - 20)
            height: UM.Theme.getSize("action_button").height
        ...
        Cura.OutputDevicesActionButton
        {
            ...
            anchors.left: previewStageShortcut.visible ? previewStageShortcut.right : parent.left
            anchors.right: printButton.visible ? printButton.left : parent.right
            anchors.rightMargin: UM.Theme.getSize("default_margin").width
            anchors.leftMargin: UM.Theme.getSize("default_margin").width
            width: printButton.visible ? (previewStageShortcut.visible ? (parent.width / 3 + 40) : (parent.width / 2 + 20)) : (previewStageShortcut.visible ? (parent.width / 2 + 20) : parent.width)
        ...
        Cura.SecondaryButton
        {
            ...
            fixedWidthMode: true
            anchors.right: parent.right
            width: previewStageShortcut.visible ? (parent.width / 3 - 20) : (parent.width / 2 - 20)
            ...
            onClicked: {
                PythonHandler.handleOpenMachineSelectionDlg()
            }
        }
